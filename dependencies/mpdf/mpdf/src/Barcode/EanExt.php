 ...
 */
class EanExt extends \WP_Ultimo\Dependencies\Mpdf\Barcode\AbstractBarcode implements \WP_Ultimo\Dependencies\Mpdf\Barcode\BarcodeInterface
{
    /**
     * @param string $code
     * @param int $length
    ...
    private function init($code, $length = 5)
    {
        ...
        if ($length == 2) {
            ...
            throw new \WP_Ultimo\Dependencies\Mpdf\Barcode\BarcodeException(\sprintf('Invalid EAN barcode value "%s"', $code));
        }
